...
const NewArrival = () => {
  return (
    <div className="mt-16 pb-24">
        ...
        <div className="card relative glass w-80">
          ...
          <div className="card-body rounded-b-xl arrival-bg">
            ...
            <div className="card-actions justify-end">
              <button className="bg-indigo-800 hover:bg-indigo-700 text-white text-sm py-2 px-4 rounded-lg">
                Shop now!
              </button>
            </div>
          </div>
      ...
      <div className="mt-16 justify-center max-w-[94rem] mx-auto flex items-center gap-6 w-full">
          ...
          <div className="card-body flex flex-col justify-between">
            <div>
              ...
              <div className="flex flex-col gap-2 items-start">
                ...
                <p className="text-3xl line-through">BDT 3,400</p>
                <p className="text-xl ">BDT 3,000</p>
