...
const ProfilePhotoSection = () => {
  ...
  return( 
  <div>
    <div className="flex relative items-start gap-6 shadow-sm shadow-gray-300 border rounded-xl p-5">
        <img src={profile?.profilePhoto} loading="lazy" className="w-32 rounded-2xl object-cover object-top" alt="" />
    ...
    <img src={edit} loading="lazy" className="w-6 cursor-pointer absolute top-5 right-5" alt="" />
    </div>
  </div>
